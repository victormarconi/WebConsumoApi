...
namespace WebConsumoApi.Controllers
{
    public class ExcelController : Controller
    {
        ...
        public ExcelController(DbProdutosContext context)
        {
            _dbocontext = context;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> EnviarDados([FromForm] IFormFile ArquivoExcel)
        {
            ...
            // await _dbocontext.AddAsync(lista);
